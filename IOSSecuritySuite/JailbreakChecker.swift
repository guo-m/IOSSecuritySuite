...
internal class JailbreakChecker {
    ...
    private static func checkExistenceOfSuspiciousFiles() -> CheckResult {
        var paths = [
            [76, 22, 16, 17, 76, 16, 1, 10, 13, 76, 5, 17, 10, 7, 2, 78, 16, 6, 17, 21, 6, 17], //"/usr/sbin/frida-server", // frida
            [76, 6, 23, 0, 76, 2, 19, 23, 76, 16, 12, 22, 17, 0, 6, 16, 77, 15, 10, 16, 23, 77, 7, 76, 6, 15, 6, 0, 23, 17, 2, 77, 15, 10, 16, 23], //"/etc/apt/sources.list.d/electra.list", // electra
            [76, 6, 23, 0, 76, 2, 19, 23, 76, 16, 12, 22, 17, 0, 6, 16, 77, 15, 10, 16, 23, 77, 7, 76, 16, 10, 15, 6, 12, 77, 16, 12, 22, 17, 0, 6, 16],    //"/etc/apt/sources.list.d/sileo.sources", // electra
            [76, 77, 1, 12, 12, 23, 16, 23, 17, 2, 19, 19, 6, 7, 60, 6, 15, 6, 0, 23, 17, 2],   //"/.bootstrapped_electra", // electra
            [76, 22, 16, 17, 76, 15, 10, 1, 76, 15, 10, 1, 9, 2, 10, 15, 1, 17, 6, 2, 8, 77, 7, 26, 15, 10, 1], //"/usr/lib/libjailbreak.dylib", // electra
            [76, 9, 1, 76, 15, 25, 14, 2],  //"/jb/lzma", // electra
            [76, 77, 0, 26, 7, 10, 2, 60, 13, 12, 60, 16, 23, 2, 16, 11],   //"/.cydia_no_stash", // unc0ver
            [76, 77, 10, 13, 16, 23, 2, 15, 15, 6, 7, 60, 22, 13, 0, 83, 21, 6, 17],    //"/.installed_unc0ver", // unc0ver
            [76, 9, 1, 76, 12, 5, 5, 16, 6, 23, 16, 77, 19, 15, 10, 16, 23],    //"/jb/offsets.plist", // unc0ver
            [76, 22, 16, 17, 76, 16, 11, 2, 17, 6, 76, 9, 2, 10, 15, 1, 17, 6, 2, 8, 76, 10, 13, 9, 6, 0, 23, 14, 6, 77, 19, 15, 10, 16, 23],   //"/usr/share/jailbreak/injectme.plist", // unc0ver
            [76, 6, 23, 0, 76, 2, 19, 23, 76, 22, 13, 7, 6, 0, 10, 14, 22, 16, 76, 22, 13, 7, 6, 0, 10, 14, 22, 16, 77, 15, 10, 16, 23],    //"/etc/apt/undecimus/undecimus.list", // unc0ver
            [76, 21, 2, 17, 76, 15, 10, 1, 76, 7, 19, 8, 4, 76, 10, 13, 5, 12, 76, 14, 12, 1, 10, 15, 6, 16, 22, 1, 16, 23, 17, 2, 23, 6, 77, 14, 7, 86, 16, 22, 14, 16],   //"/var/lib/dpkg/info/mobilesubstrate.md5sums", // unc0ver
            ...
            [76, 9, 1, 76, 9, 2, 10, 15, 1, 17, 6, 2, 8, 7, 77, 19, 15, 10, 16, 23],    //"/jb/jailbreakd.plist", // unc0ver
            [76, 9, 1, 76, 2, 14, 5, 10, 7, 60, 19, 2, 26, 15, 12, 2, 7, 77, 7, 26, 15, 10, 1], //"/jb/amfid_payload.dylib", // unc0ver
            [76, 9, 1, 76, 15, 10, 1, 9, 2, 10, 15, 1, 17, 6, 2, 8, 77, 7, 26, 15, 10, 1],  //"/jb/libjailbreak.dylib", // unc0ver
    ...
    private static func checkDYLD() -> CheckResult {
        ...
        let suspiciousLibraries = [
            ...
            [76, 77, 5, 10, 15, 6] //"/.file" // HideJB (2.1.1) changes full paths of the suspicious libraries to "/.file"
        ]
